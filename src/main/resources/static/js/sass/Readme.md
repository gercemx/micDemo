...
folder are mapped to the application's root namespace, 'apiDemo'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'apiDemo' in the same way
as `"apiDemo/sass/src"`.
